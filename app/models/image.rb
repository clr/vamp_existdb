...
=end
  ...
  def export_to_xmp(outfile)
    Avm.export_xmp(self.full_filename, outfile)
  end

  def full_filename(thumbnail = nil)
    File.join(RAILS_ROOT, 'public/uploaded_files/images', partitioned_path(self.filename)).gsub('vamp_eXistDB','spitzer.caltech.edu')
  end
